  ...
  return (
    <SideBar>
      ...
      <SideBarContent className="flex justify-start">
        <SideBarHeader className="flex justify-between w-full">
          <div>
            <SideBarTitle className="flex items-center justify-between pb-2">
              <svg
                width="136"
                height="40"
                viewBox="0 0 136 48"
                ...
                className="w-full bg-cover max-w-16 text-neutral-950 dark:text-neutral-50"
              >
                <path
              ...
              {navbarRoutes.map((menu) => (
                ...
                >
                  ...
                  <AccordionContent className="px-1 text-start">
                    <h4 className="mb-2 font-semibold uppercase text-neutral-400">
                      sections
                    </h4>
          ...
          <div className="flex flex-col gap-2">
            ...
            <h5 className="text-[10px] text-center capitalize text-neutral-500 dark:text-neutral-400">
