          ...
          <div className="flex items-center justify-between desktop-w">
            ...
            <Link href="/">
              <svg
                ...
                className="bg-cover max-w-20 text-zinc-950 dark:text-zinc-50"
              >
                <path
            ...
            <div className="flex items-center gap-2">
              <Button
                size="icon"
                className="bg-transparent shadow-none text-zinc-950 dark:text-zinc-50 hover:bg-transparent dark:bg-transparent dark:hover:bg-transparent dark:shadow-none"
              >
